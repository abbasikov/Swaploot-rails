class PriceEmpireSuggestedPriceJob
    ...
    def perform
        ...
        ActiveRecord::Base.transaction do
            ...
            begin
                response = HTTParty.get("https://api.pricempire.com/v3/items/prices?api_key=#{PRICEEMPIRE_API_KEY}&currency=USD&sources=buff&sources=waxpeer&sources=csgoempire")
